...
Department Class:
● Attributes: departmentName (string), employees (pointer to an array of Employee
objects), numEmployees (int to keep track of the number of employees).
● Methods:
...
● Create a Department object and use the addEmployee method to add employees to the
department.
● Use the displayEmployees method to list all employees in the department.
● Ensure proper use of pointers, especially in managing the array of employees in the
department.