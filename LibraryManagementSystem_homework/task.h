...
● borrowBook(Book *book) to simulate borrowing a book, which takes a pointer
to a Book object.

Main Function:
● Create an array of Book objects and an array of Member objects.
● Demonstrate the borrowing process by having a member borrow a book. Use pointers
to refer to and manipulate the book and member objects.
...
● Make sure to use pointers appropriately when implementing the borrowBook method and